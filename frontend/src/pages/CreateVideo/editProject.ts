 ...
 * `backend/src/services/video/editProject.ts` — mesma convenção já usada
 ...
 * por razões de isolamento entre pipelines). Este arquivo (frontend) usa a
 * lógica para o monitor, a timeline e o resumo "O que vai ser enviado" ao
 * vivo; o backend usa a MESMA lógica para validar e medir a duração ao
 * salvar um projeto (`routes/editProjects.ts`).
 *
